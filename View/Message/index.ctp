...
<div class="container">
    <div class="mt10">
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="/message/new" class="btn btn-theme mt30">Ecrire un message</a>
            </div>
        </div>
        <div class="row mt20">
            <div class="col-md-12">
                        ...
                        <div class="forum-bloc p10">
                            <div class="row">
                                ...
                                <div class="col-xs-7 col-md-7 col-sm-6">
                                    <h3 class="forum-category-title"><a href="/message/<?= $this->requestAction('Forum/replaceSpace/'.$mp['Conversation']['title'], ['plugin' => 'forum']); ?>.<?= $mp['Conversation']['id']; ?>/"><?= $mp['Conversation']['title']; ?></a></h3>
                                </div>
